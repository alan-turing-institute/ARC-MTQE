...
To make predictions using GPT, you will need to have access to the Azure OpenAI Service. The API key will need to be saved as environment variables named OPENAI_API_KEY. To do this in a Mac terminal:
